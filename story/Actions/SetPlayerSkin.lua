...
SetPlayerSkin.PlayerSkins = {
    -- SetPlayerSkin(0, "Carl \"CJ\" Johnson"),
    -- SetPlayerSkin(1, "The Truth"),
    -- SetPlayerSkin(2, "Maccer"),
    -- SetPlayerSkin(3, "Andre"),
    -- SetPlayerSkin(4, "Barry \"Big Bear\" Thorne[Thin]"),
    -- SetPlayerSkin(5, "Barry \"Big Bear\" Thorne[Big]"),
    -- SetPlayerSkin(6, "Emmet"),
    SetPlayerSkin(7, "Black man in a blue jeans jacket and beige pants"),
    -- SetPlayerSkin(8, "Janitor"),
    -- SetPlayerSkin(9, "Normal Ped"),
    SetPlayerSkin(10, "Old Woman"),
    -- SetPlayerSkin(11, "Casino croupier"),
    -- SetPlayerSkin(12, "Rich Woman"),
    -- SetPlayerSkin(13, "Street Girl"),
    -- SetPlayerSkin(14, "Normal Ped"),
    -- SetPlayerSkin(15, "Mr.Whittaker(RS Haul Owner)"),
    -- SetPlayerSkin(16, "Airport Ground Worker"),
    -- SetPlayerSkin(17, "Businessman"),
    SetPlayerSkin(18, "Tall black man in red shorts"),
    -- SetPlayerSkin(19, "DJ"),
    -- SetPlayerSkin(20, "Rich Guy(Madd Dogg's Manager)"),
    -- SetPlayerSkin(21, "Normal Ped"),
    -- SetPlayerSkin(22, "Normal Ped"),
    -- SetPlayerSkin(23, "BMXer"),
    -- SetPlayerSkin(24, "Madd Dogg Bodyguard"),
    -- SetPlayerSkin(25, "Madd Dogg Bodyguard"),
    -- SetPlayerSkin(26, "Backpacker"),
    -- SetPlayerSkin(27, "Construction Worker"),
    -- SetPlayerSkin(28, "Drug Dealer"),
    -- SetPlayerSkin(29, "Drug Dealer"),
    -- SetPlayerSkin(30, "Drug Dealer"),
    -- SetPlayerSkin(31, "Farm - Town inhabitant"),
    -- SetPlayerSkin(32, "Farm - Town inhabitant"),
    -- SetPlayerSkin(33, "Farm - Town inhabitant"),
    -- SetPlayerSkin(34, "Farm - Town inhabitant"),
    -- SetPlayerSkin(35, "Gardener"),
    -- SetPlayerSkin(36, "Golfer"),
    -- SetPlayerSkin(37, "Golfer"),
    -- SetPlayerSkin(38, "Normal Ped"),
    -- SetPlayerSkin(39, "Normal Ped"),
    -- SetPlayerSkin(40, "Normal Ped"),
    -- SetPlayerSkin(41, "Normal Ped"),
    -- SetPlayerSkin(42, "Jethro"),
    -- SetPlayerSkin(43, "Normal Ped"),
    -- SetPlayerSkin(44, "Normal Ped"),
    SetPlayerSkin(45, "White man wearing a black cap and green shorts"),
    -- SetPlayerSkin(46, "Normal Ped"),
    -- SetPlayerSkin(47, "Normal Ped"),
    -- SetPlayerSkin(48, "Normal Ped"),
    -- SetPlayerSkin(49, "Snakehead(Da Nang)"),
    -- SetPlayerSkin(50, "Mechanic"),
    -- SetPlayerSkin(51, "Mountain Biker"),
    -- SetPlayerSkin(52, "Mountain Biker"),
    -- SetPlayerSkin(53, "Unknown"),
    -- SetPlayerSkin(54, "Normal Ped"),
    -- SetPlayerSkin(55, "Normal Ped"),
    -- SetPlayerSkin(56, "Normal Ped"),
    -- SetPlayerSkin(57, "Oriental Ped"),
    -- SetPlayerSkin(58, "Oriental Ped"),
    -- SetPlayerSkin(59, "Normal Ped"),
    -- SetPlayerSkin(60, "Normal Ped"),
    SetPlayerSkin(61, "Pilot"),
    -- SetPlayerSkin(62, "Colonel Fuhrberger"),
    ---- SetPlayerSkin(63, "Prostitute"),
    ---- SetPlayerSkin(64, "Prostitute"),
    -- SetPlayerSkin(65, "Kendl Johnson"),
