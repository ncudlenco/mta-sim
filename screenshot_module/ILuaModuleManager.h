...
public:
    ...
    virtual bool GetResourceName(lua_State* luaVM, char* szName, int nameLength) = 0;
    virtual bool RegisterFunctionWithInclude(lua_State* luaVM, const char* szFunctionName, bool bRestricted, lua_CFunction Func) = 0;
};

#define MTAEXPORT extern "C" __declspec(dllexport)

#endif // __ILUAMODULEMANAGER_H