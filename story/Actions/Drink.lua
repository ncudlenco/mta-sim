Drink = class(StoryActionBase, function(o, params)
    StoryActionBase.init(o, " starts drinking from it", params.performer, params.targetItem, params.nextLocation, params.prerequisites or {}, params.closingAction or nil, params.nextAction or nil)
end)
...
function Drink:Apply()
    ...
    story.Logger:Log(self.Performer:getData('skinDescription') .. self.Description .. 
                     ". When " .. self.Performer:getData('genderNominative') .. " finishes " .. self.Performer:getData('genderNominative') .. " ", self.Performer)
