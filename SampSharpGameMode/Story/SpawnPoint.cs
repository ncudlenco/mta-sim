...
{
    public class SpawnPoint : IGenericStoryItem
    {
        // SPAWNS
        // Police dept spawns LS/SF/LV.
        public static readonly SpawnPoint[] PoliceStations = new[] {
            new SpawnPoint(1568.2250,-1693.5483,5.8906,177.0983, "Los Santos Police Department"),
            new SpawnPoint(-1604.8442,732.9442,-5.2344,37.6041, "San Fierro Police Department"),
            new SpawnPoint(2343.4553,2455.5994,14.9688,96.5022, "Las Venturas Police Department")
        };

        // Medical dept spawns LS/SF/LV.
        public static readonly SpawnPoint[] MedicalDepartments = new[] {
            new SpawnPoint(1568.2250,-1693.5483,5.8906,177.0983, "Los Santos Hospital"),
            new SpawnPoint(-1604.8442,732.9442,-5.2344,37.6041, "San Fierro Hospital"),
            new SpawnPoint(1609.5922,1820.9641,10.8280,348.1614, "Las Venturas Hospital")
        };

        // Army spawns LS/SF/LV.
        public static readonly SpawnPoint[] ArmyCamps = new[] {
            new SpawnPoint(2786.2183,-2436.7859,13.6340,82.3043, "Los Santos Army"),
            new SpawnPoint(-1308.4493,504.9661,11.1953,132.5, "San Fierro Army"),
            new SpawnPoint(272.6040,1989.7307,17.6406,268.3605, "Las Venturas Army")
        };

        public static readonly SpawnPoint[] LosSantos = new[] {
            ...
            new SpawnPoint(266.8395,-1836.9211,3.5936,172.0113, "Santa Maria beach"),
            new SpawnPoint(244.24112,-1909.1603,-0.59943676,262.56543, "in water at Santa Maria beach")
        };

        public static readonly SpawnPoint[] SanFierro = new[] {
        ...
        public static readonly SpawnPoint[] LasVenturas = new[] {
        ...
        eStoryItemType IGenericStoryItem.StoryItemType => throw new NotImplementedException();
        ...
        public SpawnPoint(double x, double y, double z, double angle, string description)
        {
            this.Position = new Vector3(x, y, z);
            this.Angle = (float)angle;
        ...
        public SpawnPoint(int cityIdx, int locationIdx)
        {
            this.CityIdx = cityIdx;
            this.LocationIdx = locationIdx;
        }

        public static SpawnPoint SetPlayerSpawnPoint(BasePlayer player, int cityIdx = -1, int locationIdx = -1)
        {
            SpawnPoint spawn = new SpawnPoint(Vector3.Zero, 0.0f);

            //TODO: Some dynamic stuff here to decide where to spawn the player
            SpawnPoint[] spawnPoints = new SpawnPoint[] { spawn };
            ...
            switch (city)
            {
                case City.None:
                    break;
                case City.LosSantos:
                    spawnPoints = SpawnPoint.LosSantos;
                    break;
                case City.SanFierro:
                    spawnPoints = SpawnPoint.SanFierro;
                    break;
                case City.LasVenturas:
                    spawnPoints = SpawnPoint.LasVenturas;
                    break;
                default:
                    break;
            }
            var randomId = locationIdx == -1 ? new Random().Next(spawnPoints.Length) : locationIdx;
        ...
        public async Task<bool> ApplyInGameAsync(params object[] parameters)
        {
            ...
            var spawn = SetPlayerSpawnPoint(player, this.CityIdx, this.LocationIdx);
            player.SendClientMessage(" is at the " + spawn.Description);
