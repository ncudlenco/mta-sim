...
function House8:Initialize(...)
    ...
    local rightSofa = Location(2370.9368, -1124.0031, 1050.8750, 95.8058, self.InteriorId, " sofa in the living room ")
    local leftSofa = Location(2374.1345, -1124.0991, 1050.8750, 262.7906, self.InteriorId, " lsofa in the living room ")
    local centralSofa = Location(2372.0334, -1122.0536, 1050.8750, 356.7915, self.InteriorId, " sofa in the living room ")
