...
SetPlayerSkin.PlayerSkins = {
    ...
    -- SetPlayerSkin(1, "An old white man in a red shirt with black and white plaids, khaki pants and with a red head band"),
    ...
    -- SetPlayerSkin(12, "A young latina woman in a black dress"),
